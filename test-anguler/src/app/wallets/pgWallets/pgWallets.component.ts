...
@Component({
    ...
    styleUrls: ['./pgWallets.component.scss'],
    templateUrl: './pgWallets.component.html',
    providers: [WalletService]
})

export class PgWalletsComponent {
    ...
    getPage() {
        this._service.getAllPgData(this.rowsOnPage, this.p).subscribe(
            res => {
